...
function orig_addProximityCheck(ply)
	...
	return (#(plyCoords - GetEntityCoords(tgtPed)) < distance) and (GetEntityHealth(tgtPed) ~= 101 and GetEntityHealth(tgtPed) ~= 0)
end
...
function addNearbyPlayers()
	...
	if GetEntityHealth(PlayerPedId()) == 101 or GetEntityHealth(PlayerPedId()) == 0 then return end
