...
local animacoes = {
	...
	{ nome = "eai" , dict = "move_m@intimidation@unarmed" , anim = "idle" , andar = true , loop = true },
	...
	{ nome = "dancar257" , dict = "anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity" , anim = "hi_dance_facedj_09_v2_female^1" , andar = false , loop = true },
	{ nome = "dancar258" , dict = "anim@amb@nightclub@dancers@crowddance_facedj@hi_intensity" , anim = "hi_dance_facedj_09_v2_female^3" , andar = false , loop = true },
	{ nome = "dancar259" , dict = "anim@amb@nightclub@mini@dance@dance_solo@female@var_b" , anim = "low_center_down" , andar = false , loop = true },
	...
	{ nome = "bixa" , anim = "WORLD_HUMAN_PROSTITUTE_LOW_CLASS", ProibidoArmado = true },
	{ nome = "britadeira" , dict = "amb@world_human_const_drill@male@drill@base" , anim = "base" , prop = "prop_tool_jackham" , flag = 15 , hand = 28422 },
	{ nome = "cerveja" , anim = "WORLD_HUMAN_PARTYING", ProibidoArmado = true },
	{ nome = "churrasco" , anim = "PROP_HUMAN_BBQ", ProibidoArmado = true },
	{ nome = "consertar" , anim = "WORLD_HUMAN_WELDING", ProibidoArmado = true },
	...
	{ nome = "fumar" , anim = "WORLD_HUMAN_SMOKING", ProibidoArmado = true },
	{ nome = "fumar2" , anim = "WORLD_HUMAN_PROSTITUTE_HIGH_CLASS", ProibidoArmado = true },
	{ nome = "fumar3" , anim = "WORLD_HUMAN_AA_SMOKE", ProibidoArmado = true },
	{ nome = "fumar4" , anim = "WORLD_HUMAN_SMOKING_POT", ProibidoArmado = true },
	...
	{ nome = "tragar" , anim = "WORLD_HUMAN_DRUG_DEALER", ProibidoArmado = true },
	{ nome = "trotar" , dict = "amb@world_human_jog_standing@male@fitidle_a" , anim = "idle_a" , andar = false , loop = true },
	{ nome = "esquentar" , anim = "WORLD_HUMAN_STAND_FIRE", ProibidoArmado = true },
    ...
    { nome = "abracoombro" , dict = "misscarsteal2chad_goodbye" , anim = "chad_armsaround_girl" , andar = false , loop = true },
    { nome = "abracoombro2" , dict = "misscarsteal2chad_goodbye" , anim = "chad_armsaround_girl" , andar = true , loop = true },
	{ nome = "dedo" , dict = "anim@mp_player_intupperfinger",  anim = "idle_a_fp" , andar = false , loop = false },
			...
			if not IsPedInAnyVehicle(ped) and not emote.carros then
				if nome == emote.nome then
					...
					if emote.ProibidoArmado then
						if IsPedArmed(ped, 7) then
							TriggerEvent('Notify', 'negado', 'ERRO ANIMAÇÃO!', 'Você não pode fazer essa animação armado.')
							return
						end
					end
					...
					-- FazendoDict, FazendoAnim = emote.dict, emote.anim
				end
			else
...
-- 	while true do
-- 		if FazendoAnim ~= '' then
-- 			if not IsEntityPlayingAnim(PlayerPedId(), FazendoDict, FazendoAnim, 3) then
-- 				vRP._playAnim(true,{{FazendoDict, FazendoAnim}},true)
-- 			end
-- 		end
-- 		Wait(1000)
-- 	end
