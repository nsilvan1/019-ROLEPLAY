...
EMP = Tunnel.getInterface("desmanche_itens")
...
-----------------------------------------------------------------------------------------------------------------------------------------
local locais = { 
	{ ['x'] = 985.94, ['y'] = -138.4, ['z'] = 73.1, ['perm'] = "motoclub.permissao" }, --  985.94,-138.4,73.1
	{ ['x'] = -1163.5, ['y'] = -2009.61, ['z'] = 13.19, ['perm'] = "hells.permissao" }, -- 465.7,-1315.35,29.23  
	{ ['x'] = 1201.29, ['y'] = -3119.47, ['z'] = 5.02, ['perm'] = "admin.permissao" }, -- 1201.29,-3119.47, 5.02 
}  
-----------------------------------------------------------------------------------------------------------------------------------------
-- DESMANCHE
-----------------------------------------------------------------------------------------------------------------------------------------
...
Citizen.CreateThread(function()
	while true do
		sleep2 = 1000
		local ped = PlayerPedId()
		local CoordenadaX,CoordenadaY,CoordenadaZ = table.unpack(GetEntityCoords(ped))
					...
					if #policia <= 0 then
						...
						local player = vRP.getUserSource(parseInt(v))
							if player then
								...
								TriggerClientEvent('chatMessage',player,"911",{64,64,255},"Algo ilegal está ocorrendo, favor verifica.")
								blips = vRPclient.addBlip(player,CoordenadaX,CoordenadaY,CoordenadaZ,10,5,".Ocorrência",0.5,false)
