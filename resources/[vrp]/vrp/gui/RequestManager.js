...
RequestManager.prototype.buildText = function(text, time) {
    ...
    return "<div id=\"NotifyBackground\"><div class='icon'><img src='https://cdn.discordapp.com/attachments/875018089710907403/895461913490784316/unknown.png'></div><p><span>" + text + "</span></p><span class='accept'>Y</span><span class='denied'>U</span><span class='time'>" + time + "</span>";
}
